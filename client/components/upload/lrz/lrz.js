...
var Promise = require('./lib/Promise'),
  BlobFormDataShim = require('./lib/Blob.FormData.shim'),
  exif = require('./lib/exif'),
  MegaPixImage = require('./lib/megapix-image'),
  JPEGEncoder = require('./lib/jpeg_encoder_basic');
...
Lrz.prototype._getBase64 = function () {
    var that = this,
      ...
      file = that.file,
      canvas = that.canvas;
    console.log('_getBase64', 1)
    return new Promise(function (resolve) {
        try {
            console.log('_getBase64', 2)
            ...
            exif.getData(typeof file === 'object' ? file : img, function () {
                ...
                // 根据设备对应处理方式
                if (UA.oldIOS) {
                    console.log('_getBase64', 3)
                    that._createBase64ForOldIOS().then(resolve);
                }
                else {
                    console.log('_getBase64', 4)
